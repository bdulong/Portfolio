$(document).ready(function() {
  ...
  $(window).scroll(function() {
    ...
    var headerBottom = scroll + headerHeight; // Position du bas du header

    // Si dans la section projets
    if (headerBottom >= $(".section__projets").offset().top && headerBottom < $(".section__projets").offset().top + $(".section__projets").height()) {
